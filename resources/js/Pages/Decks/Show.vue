    ...
    <AppLayout>
        <div class="px-4 sm:px-8 py-8 max-w-4xl mx-auto">
            ...
            <div class="flex items-center gap-3 sm:gap-4 mb-6">
                ...
                <div v-if="allCards.length > 0" class="flex items-center gap-2 flex-shrink-0">
                    <Link
                        v-if="deck.is_active"
            ...
            <div v-if="allCards.length === 0" class="text-center py-16">
                ...
                <p class="text-gray-500 dark:text-gray-400 mb-6">Add your first card, or let an AI do it for you.</p>
                ...
                <p class="text-xs text-gray-400 dark:text-gray-500 mt-6 max-w-md mx-auto">
                    Connect Claude Code or another AI agent to this app's API and it will generate a full deck in seconds.
                </p>
            </div>
